Moved here: https://github.com/kekekeks/evhttp-sharp (extracted libevent-based http listener to separate assembly, probably will implement hosts for another frameworks)
